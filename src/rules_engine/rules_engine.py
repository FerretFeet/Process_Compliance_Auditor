...
from src.custom_exceptions import InvalidRuleFilterException
...
rules_file_path = project_root / get_project_config()['rules_path']
...
class RulesEngine:
    ...
    def __init__(self, *,
                 toml_rules_path: pathlib.Path = rules_file_path,
    ...
    def filter_rules(self, rules: dict[str, rules_engine.Rule], filters: list[str] | None)\
    ...
    #     """Resolve a rule_builder condition."""
    #     if rule.evaluator:
